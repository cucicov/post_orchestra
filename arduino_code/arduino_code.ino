...
#define PIN 6                 //pinul digital pentru date la care este conectata banda sau inelul de neopixeli
#define N_LEDS 490       //numarul de LED-uri neopixeli de pe banda sau inel
